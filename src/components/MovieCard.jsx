...
let MovieCard = ({clickHandler, iconClickHandler, rawData}) => {

    return (    
       <div className="w-32 xs:w-36 sm:w-40 lg:w-44 my-1 cursor-pointer relative">
            <button onClick={() => iconClickHandler({movieId: rawData.id})}><SmallIcon color="bg-green-500" iconSrc="images/add-icon.svg" /></button>
